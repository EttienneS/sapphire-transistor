    ...
    public class StructureDefinitionManager : GameServiceBase, IStructureDefinitionManager
    {
        ...
        public override void Initialize()
        {
            ...
            StructureDefinitions = new List<StructureDefinition>
            {
                ...
                new StructureDefinition("Cabin", "Cabin", 500, StructureDefinition.StructureType.Cabin, "CabinBehaviour", true, (coord) => _validator.Value.EmptyAndTerrainMatches(coord,StructureDefinition.StructureType.Cabin, TerrainType.Forrest ) ),
                new StructureDefinition("Field", "Field", 500, StructureDefinition.StructureType.Field, "NoBehavior", false, (coord) => _validator.Value.EmptyAndTerrainMatches(coord,StructureDefinition.StructureType.Field, TerrainType.Grass) ),
            };
        }
    }
}